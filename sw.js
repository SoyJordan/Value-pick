const CACHE='soyjordan-v2-build2000';
const FILES=['./index.html','./css/styles.css?v=2000','./js/app-core.js?v=2000','./js/v2-ui.js?v=2000','./manifest.json','./logo.svg','./icon-192.png','./icon-512.png'];
