const CACHE='soyjordan-v2-5-build2500';
const FILES=['./index.html','./css/styles.css?v=2500','./js/app-core.js?v=2500','./js/v2-ui.js?v=2500','./js/v2500.js?v=2500','./js/historical-db.js?v=2500','./manifest.json','./logo.svg','./icon-192.png','./icon-512.png'];
