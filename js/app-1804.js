...
async function buildResultCanvas(r){
  ...
  // ---------- Footer ----------
  y+=26;
  drawText(ctx,'Motor λ: V1.7.1 · Selector jerárquico: V1.8.0 · BUILD 1804',W/2,y+18,15,'700','#555','center');
...
function loadTest(){
 ...
 document.getElementById("vp-test-status").textContent="✅ Prueba V1.8.0 build 1804 cargada (stake visible también en captura + Top General corregido).";
}
