...
async function buildResultCanvas(r){
  ...
  // ---------- Footer ----------
  y+=26;
  drawText(ctx,'Motor λ: V1.7.1 · Selector jerárquico: V1.8.0 · BUILD 1806',W/2,y+18,15,'700','#555','center');
...
(function(){
const test={
 meta:{date:"2026-08-15",league:"Liga de Prueba",season:"2026/27",leagueAvg:"1.50",dataSource:"Datos ficticios",home:"Atlético Aurora",away:"Deportivo Central",notes:"PRUEBA V1.8.0 build 1806 — datos ficticios."},
...
function loadTest(){
 ...
 document.getElementById("vp-test-status").textContent="✅ Prueba V1.8.0 build 1806 cargada (stake visual calibrado: WATCH frágil = SOLO SEGUIMIENTO; NO BET = —).";
}
