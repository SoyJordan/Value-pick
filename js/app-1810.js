...
function lambdaContradiction(row,opts={}){
 ...
 // Build 1810: la dirección deportiva del λ manda antes que el precio.
...
function marketLambdaCoherence(row,opts={}){
 ...
 // Build 1810: reglas propias de coherencia para GOLES y BTTS.
...
function rankingScore(row,opts={}){
 // V1.8.0: Score base + penalizaciones de coherencia estructural antes de premiar el precio.
 ...
 return clamp(base-c.penalty-mc.penalty,0,100);
}
...
function selectorEligibility(row,opts={}){
 ...
 // Build 1810 · coherencia direccional primero, precio después.
 ...
 // Build 1810 · coherencia específica por mercado para goles y ambos marcan.
...
async function buildResultCanvas(r){
  ...
  // ---------- Footer ----------
  y+=26;
  drawText(ctx,'Motor λ: V1.7.1 · Selector jerárquico: V1.8.0 · BUILD 1810',W/2,y+18,15,'700','#555','center');
...
(function(){
const test={
 meta:{date:"2026-08-15",league:"Liga de Prueba",season:"2026/27",leagueAvg:"1.50",dataSource:"Datos ficticios",home:"Atlético Aurora",away:"Deportivo Central",notes:"PRUEBA V1.8.0 build 1810 — datos ficticios."},
...
function loadTest(){
 ...
 document.getElementById("vp-test-status").textContent="✅ Prueba V1.8.0 build 1810 cargada (stake visual calibrado: WATCH frágil = SEGUIMIENTO; NO BET = —).";
}
...
// Build 1810 · combinadas integradas en Historial, sin sección independiente.
