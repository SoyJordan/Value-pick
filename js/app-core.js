...
let d=r.diagnostics;
let h=`<div class="card result-capture-card"><div class="result-head"><h2>🎯 Resultado V2.0</h2><button type="button" class="download-result-btn" onclick="downloadResultCapture()">📸 Descargar resultado</button></div>
...
async function buildResultCanvas(r){
  ...
  drawText(ctx,'V2.0',W-pad-24,y+55,21,'700','#fff','right');
  y+=brandH+24;
  ...
  // ---------- Footer ----------
  y+=26;
  drawText(ctx,'Motor λ: V1.7.1 · Selector jerárquico: V2.0 · BUILD 2000',W/2,y+18,15,'700','#555','center');
...
if("serviceWorker"in navigator&&location.protocol!=="file:")navigator.serviceWorker.register("sw.js?ver=2.0-build2000").catch(()=>{});



(function(){
const test={
 meta:{date:"2026-08-15",league:"Liga de Prueba",season:"2026/27",leagueAvg:"1.50",dataSource:"Datos ficticios",home:"Atlético Aurora",away:"Deportivo Central",notes:"PRUEBA V2.0 build 2000 — datos ficticios."},
...
function loadTest(){
 ...
 document.getElementById("vp-test-status").textContent="✅ Prueba V2.0 build 2000 cargada (stake visual calibrado: WATCH frágil = SEGUIMIENTO; NO BET = —).";
}
