...
- Backup actualizado a V1.6.2.8.1 y compatibilidad con datos V1.6.1.
...
## V1.6.2.8 — Auditoría postpartido
...
- `<title>` verificado como `SoyJordan Picks V1.6.2.8`.
- Marcador visible `build 1628`.
